...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errormessege = 'Authendication failed';
      if (error.toString().contains('EMAIL_EXISTS')) {
        errormessege = 'this Email alredy exists';
      } else if (error.toString().contains('INVALID_EMAIL')) {
        errormessege = 'Invalid email';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errormessege = 'Your password is too weak';
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errormessege = 'cant find your Email';
      } else if (error.toString().contains('INVALID_PASSWORD')) {
        errormessege = 'Invalid password';
      }
      showdialogmessege(errormessege);
    } catch (error) {
      var errormessege = 'oops! sorry please try again later';
      showdialogmessege(errormessege);
    }
